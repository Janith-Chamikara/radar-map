    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-black p-4">
      <div className="w-full max-w-3xl">
        <div className="mb-4 flex items-center justify-between">
          <h1 className="font-mono text-xl font-bold text-green-500">SYSTEM INFILTRATION</h1>
        ...
        <div className="relative overflow-hidden rounded-md border border-green-500/30 bg-black p-4 shadow-lg shadow-green-500/10">
          <div className="absolute left-2 top-2 font-mono text-xs text-green-500">TARGET ACQUISITION</div>
          <div className="absolute right-2 top-2 font-mono text-xs text-green-500">SEC LEVEL: ALPHA</div>
        ...
        <div className="mt-4 font-mono text-xs text-green-500/70">
          <div className="animate-typing overflow-hidden whitespace-nowrap">
            &gt; Initializing breach protocol... Target identified... Preparing exploit vectors...
          </div>
        </div>
      </div>
    </main>
